...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Student s1 = new Student("Ñåðãåé", 21, 101);
        Student s2 = new Student("Àíäðåé", 22, 111);
        Student s3 = new Student("Èâàí", 22, 121);
        Student s4 = new Student("Èãîðü", 23, 301);
        Student s5 = new Student("Äàøà", 25, 171);
        Student s6 = new Student("Ëåíà", 23, 104);
        students.add(s1);
        students.add(s2);
        students.add(s3);
        students.add(s4);
